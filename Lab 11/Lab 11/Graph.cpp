...
bool Graph::hasEdge(int from, int to) {  // check if edge exists
...
int Graph::getSize() { // returns number of vertices
	return size;
}
...
void Graph::Print(){ // prints all vertices and their connections
