...
(Task3.cpp, Task4.cpp, Task5.cpp), two must be commented out at all times. To uncomment the
the entire file, you need only remove the top block comment character.
