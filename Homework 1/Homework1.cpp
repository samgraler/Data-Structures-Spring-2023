...
bool exists(const string& fileName) // Returns true if the filename passed in exists
{
...
void print_book_data(const string& fileName, Book& b, char& printFrequency, bool& exists) // prints book data to the filename specified
{
    ...
    if (printFrequency == 'Y') // If the user indicates they want the frequencies printed in the file
    {
        char c = 97;
        ...
        destFile << setprecision(4) << endl; // sets precision of percentages to 4 digits
