...
//        2. Create a hash table that uses 2D tableays with 100 slots each 5 deep.Once the 5 are full,
...
//1. Create a hash table that uses a 1D tableay and linear probing to handle collisions.This
